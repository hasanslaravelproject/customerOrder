                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('all-food.index') }}">All Food</a>
                            @endcan
                            @can('view-any', App\Models\FixedFood::class)
                            <a class="dropdown-item" href="{{ route('fixed-foods.index') }}">Fixed Foods</a>
                            @endcan
                            ...
                            @endcan
                            @can('view-any', App\Models\MenuCategory::class)
                            <a class="dropdown-item" href="{{ route('menu-categories.index') }}">Menu Categories</a>
                            @endcan
