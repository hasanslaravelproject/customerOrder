<div>
    ...
    <x-modal id="menu-orders-modal" wire:model="showingModal">
                ...
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        ...
                        >
                            ...
                            @foreach($menuUsers as $value => $label)
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.menu_orders.inputs.delivery')
                    </th>
                    <th class="text-right">
                        @lang('crud.menu_orders.inputs.number_of_guest')
                    </th>
                    <th class="text-left">
                        @lang('crud.menu_orders.inputs.user_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
