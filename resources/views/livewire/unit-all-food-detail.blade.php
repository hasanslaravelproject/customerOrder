<div>
    ...
    <x-modal id="unit-all-food-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="food.menu_category_id"
                            label="Menu Category"
                            wire:model="food.menu_category_id"
                        >
                            <option value="null" disabled>Please select the Menu Category</option>
                            @foreach($unitMenuCategories as $value => $label)
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.unit_all_food.inputs.name')
                    </th>
                    <th class="text-left">
                        @lang('crud.unit_all_food.inputs.menu_category_id')
                    </th>
                    <th class="text-right">
                        @lang('crud.unit_all_food.inputs.divnumber')
                    </th>
                    <th class="text-left">
                        @lang('crud.unit_all_food.inputs.image')
                    </th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="text-left">
                        {{ optional($food->menuCategory)->name ?? '-' }}
                    </td>
